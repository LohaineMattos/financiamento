...
void main() => runApp(const GreenFinanceApp());

class GreenFinanceApp extends StatelessWidget {
  const GreenFinanceApp({super.key});

  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Simulador Verde',
      theme: ThemeData(
...
class _FinanceScreenState extends State<FinanceScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Simulador Verde'),
